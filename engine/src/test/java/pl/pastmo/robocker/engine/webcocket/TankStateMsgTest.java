...
public class TankStateMsgTest {
    ...
    public void tankStateSerialization() throws JsonProcessingException {
        ...
        assertEquals("{\"tanks\":[{\"x\":13.0,\"y\":42.0,\"id\":112,\"playerId\":1034,\"angle\":0.1,\"lifeLevel\":3,\"turret\":{\"angle\":0.2,\"angleVertical\":0.3}}]}", result);
    }
    ...
    public void fromTank() throws JsonProcessingException, ConfigurationException {
        ...
        player.addTank((new Tank()).setX(105.0).setY(41.1).setAngle(0.3).setTurret((new Turret()).setAngle(0.5).setAngleVertical(0.6)));
        ...
        String result = mapper.writeValueAsString(tankStateMsg);
        assertEquals("{\"x\":105.0,\"y\":41.1,\"id\":1,\"playerId\":3,\"angle\":0.3,\"lifeLevel\":3,\"turret\":{\"angle\":0.5,\"angleVertical\":0.6}}", result);
    }
}
