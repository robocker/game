    ...
    constructor () {
      ...
      render () {
        ...
        return (
              ...
              <ScaledModelWithProgress rootUrl={`${baseUrl}BoomBox/glTF/`} sceneFilename='BoomBox.gltf' scaleTo={5}
            progressBarColor={Color3.FromInts(255, 165, 0)} center={new Vector3(2.5, 5, 5)}
